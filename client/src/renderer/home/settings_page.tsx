...
export class SettingsPage extends React.Component<Props, State> {
  ...
  getPatientInfoObject() {
    return this.state.info !== undefined
      ? this.state.info
      : ({} as PatientInfo);
  }
  ...
  handleSubmit = () => {
    updatePatientInfo(this.state.info!)
      .then(resp => {
    ...
    return (
      <div>
        ...
        <Form.Item {...formItemLayout} label="Blood Type">
          <Select
            value={this.state.info!.bloodType}
            placeholder="--"
  ...
  render() {
    ...
    return (
      <Card title="Your Settings" loading={this.state.isLoading}>
        <Form>
          <Form.Item {...formItemLayout} label="E-mail">
            <Input
              placeholder="me@medfs.com"
